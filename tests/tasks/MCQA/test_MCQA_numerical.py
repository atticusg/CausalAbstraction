...
from causalab.tasks.MCQA import causal_models, counterfactuals  # noqa: F401
...
def test_pinned_samples() -> None:
    ...
    assert len(actual_samples) == len(expected_samples), (
        ...
        f"`uv run python scripts/update_task_pins.py --task=MCQA "
