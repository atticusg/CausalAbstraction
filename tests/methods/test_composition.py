...
class TestComposedFeaturizerInterventionUnit:
    """Composed featurizers plug into the intervention-builder pipeline."""

    pytestmark = pytest.mark.unit

    def test_interchange_swaps_through_compose_inverse(
    ...
    def test_steering_adds_in_feature_space(self, rng: torch.Generator) -> None:
        x = randn((2, 6), rng)
        steering_vec = randn((2, 4), rng)
