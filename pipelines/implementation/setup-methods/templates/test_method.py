...
Lives at $WORKDIR/code/methods/{{METHOD_NAME}}/tests/test_{{METHOD_NAME}}.py.
...
implementation begins (Step 4 of the setup-methods guide), flip the body to a real shape
