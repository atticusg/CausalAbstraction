...
hypotheses were certified upstream (see the develop-causal-model report format in the
`../../answer-research-question/hypothesis-generation/hypothesis-generation.md` skill). Derived from the iterated name-sorting
