...
for your task. It ships working so that the ``develop_hypothesis`` analysis runs
before you edit.
...
(see the causal-analysis handbook, plugins/capabilities/research-handbooks/causal-handbook.md,
...
The ``develop_hypothesis`` analysis reads, from the bottom of this file:
...
# ---------------------------------------------------------------------------
# Registries read by the develop_hypothesis analysis
# ---------------------------------------------------------------------------
