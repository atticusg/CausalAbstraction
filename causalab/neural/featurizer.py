...
and composed featurizers.

A featurizer is a *feature space*: paired modules mapping an activation to
features and back, with the residual the mapping cannot represent carried along
so it can be restored. What to *do* in that space is
:mod:`causalab.neural.interventions`.
