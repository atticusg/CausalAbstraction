...
and removing the key restores the original behaviour exactly. The engine forces
...
Duplicating library internals is normally how an engine rots silently. Here it is
...
def _post_softmax_math(module: Any) -> tuple[Callable[..., Any], Callable[..., Any]]:
    ...
    the engine can force to eager these resolve; a family where they do not
